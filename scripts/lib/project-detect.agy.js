...
/**
 * Resolve project directory for Antigravity environment.
 * Prioritizes:
 * 1. Explicit projectDir argument (if provided and non-empty string)
 * 2. CLAUDE_PROJECT_DIR environment variable (set by agy-adapter setupEnvironment)
 * 3. AGY_PROJECT_DIR or WORKSPACE_DIR environment variables
 ...
 * @param {string} [projectDir] - Project directory (defaults to resolved project directory)
